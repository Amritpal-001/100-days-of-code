...
def WordCloudSingleFile(  DirectoryOfile , FileDefaultName = 'WordCloud' , verbose = 1 , savetoDirectory=True ,
    ...
    if savetoDirectory == True:
        OutputImagePath = os.path.dirname(DirectoryOfile) + FileDefaultName
...
WordCloudSingleFile("D:\C4M\Ontologies\COVID draft 3.txt" , savetoDirectory = False)