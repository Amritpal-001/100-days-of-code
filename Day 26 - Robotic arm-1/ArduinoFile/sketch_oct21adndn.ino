...
//-->Adjustable Value!
const int servoSpeed = 0;// Adjustable delay in milliseconds between servo position updates, Expirement with diff values. 0= Full Speed, Higher Values = Slower Speed
